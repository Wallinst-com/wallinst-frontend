      ...
      <div className="min-h-screen bg-white px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            Wallinst ("we", "our", or "us") respects your privacy and is committed to
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>
              <strong>Account Information:</strong> Email address, name, and company
            ...
            <li>
              ...
              engagement metrics, and AI-generated insights derived from those
              interactions.
            </li>
            <li>
              <strong>Technical Data:</strong> Log data, IP address, browser type,
              and usage analytics for security and performance.
            </li>
          </ul>
          ...
          {/* ===================== */}
          {/* 3. Instagram & Meta Data Use */}
          {/* ===================== */}
          <h2 className="text-xl font-semibold mt-8 mb-3">
            3. Instagram & Meta Data Usage
          </h2>
          ...
          <p className="text-gray-700 mb-4">
            AI processing does not make legal or financial decisions and is used
            strictly for business insight and prioritization purposes.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            Data is stored only for as long as necessary to provide our services or
          ...
          <p className="text-gray-700 mb-4">
            Wallinst does not sell or rent personal data.
          </p>
